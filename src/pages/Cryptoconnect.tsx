...
export const CryptoConnect = () => {
    ...
    const [connectButton, setConnectButton] = useState<string>("Connect Wallet");
    ...
    return (
      <div>
        ...
        className="w-full text-white bg-gray-800 hover:bg-gray-600 font-medium rounded-2xl text-sm px-4 py-3"
            ...
            <div className="relative p-4 w-full max-w-md">
              <div className="relative bg-white rounded-2xl shadow ">
                <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
                  <h3 className="text-lg font-semibold text-gray-900 text-black">Connect wallet</h3>
                  <button
                    type="button"
                ...
                <div className="p-4 md:p-5">
                  ...
                  <li>
                          <a href="#" onClick={connectWallet} className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow ">
                  ...
                  <div>
                      <a href="https://ethereum.stackexchange.com/questions/110704/what-happens-when-you-connect-wallet-to-website#:~:text=Connecting%20your%20wallet%20doesn't,user%2C%20need%20to%20accept%20manually." className="inline-flex items-center text-xs font-normal text-gray-500 hover:underline dark:text-gray-400">
